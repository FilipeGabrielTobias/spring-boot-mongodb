...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... arg0) throws Exception {
        ...
        Post post1 = new Post(null, sdf.parse("31/01/2019"), "Partiu Viagem!", "Vou viajar para São Paulo!", filipe);
        Post post2 = new Post(null, sdf.parse("31/01/2019"), "Bora Trabalhar", "Hoje o dia vai ser longo!", bob);
